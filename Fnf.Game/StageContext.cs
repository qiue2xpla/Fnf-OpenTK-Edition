...
namespace Fnf.Game
{
    public class StageContext : GameObject, IUpdatable, IRenderable
    {
        public Dictionary<string, GameObject> Elements;
        public List<(Vector2 factor, GameObject parent)> ParallaxLayers;
        ...
        public bool isUpdatable { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public bool isRenderable { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }

        public StageContext(string weekName, string difficulty, string[] tracks)
        {
            Elements = new Dictionary<string, GameObject>();
            UpdateList = new List<Action>();
            RenderList = new List<IRenderable>();
            ParallaxLayers = new List<(Vector2 factor, GameObject parent)>();
